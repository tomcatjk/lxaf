                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12 ">
								...
								<c:forEach items="${page.list}" var="chatHistory">
									...
									<c:if test="${fns:getUser().loginName != userid1}">
									<div class="chat-message chat-message-left">
                                        <img class="message-avatar" src="${fns:getByLoginName(userid1).photo}" alt="">
                                        <div class="message">
                                            <a class="message-author" href="#"> ${fns:getByLoginName(userid1).name}</a>
