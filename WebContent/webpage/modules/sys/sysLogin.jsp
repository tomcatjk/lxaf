						...
						<div class="login-container">
							...
							<div class="center">
								<h1>
									...
									<div style="margin: 0 auto;"><font style="color: #0E3460;">联讯安防智能预警监控管理系统</font></div>
									<br>
								</h1>
										...
										<div class="widget-main bound">
											...
											<form:form id="inputForm" modelAttribute="user" action="${ctx}/sys/register/registerUser" method="post" class="form-group form-horizontal">
												...
												<fieldset>
													...
													<label class="block clearfix">
														<span class="block input-icon input-icon-right">
															<input id="code" name="randomCode" type="text" value="" maxlength="" minlength="4" class="required"  placeholder="验证码"/>
