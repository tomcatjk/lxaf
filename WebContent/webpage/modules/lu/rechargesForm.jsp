...
<body class="hideScroll">
		<form:form id="inputForm" modelAttribute="recharges" action="${ctx}/lu/recharges/save" method="post" class="form-horizontal">
		<form:hidden path="id"/>
		...
		<table class="table table-bordered  table-condensed dataTables-example dataTable no-footer">
		   <tbody>
				...
				<tr>
					<td class="width-15 active"><label class="pull-right">受理人：</label></td>
					<td class="width-35">
					...
					<td class="width-35">
						<input id="createDate" name="createtime" type="text" maxlength="20" class="laydate-icon form-control layer-date required"
							   value="<fmt:formatDate value="${recharges.createtime}" pattern="yyyy-MM-dd HH:mm:ss"/>"/>
					</td>
				</tr>
				<tr>
					<td class="width-15 active"><label class="pull-right">记录人：</label></td>
					<td class="width-35">
						<form:input path="recordPerson" htmlEscape="false"    class="form-control "/>
					</td>
		   		...
		   		<tr>
					<td class="width-15 active"><label class="pull-right">状态[正在处理=1，到账=2]：</label></td>
					<td class="width-35">
