 ...
 * 
 */
@WebServiceClient(name = "Service", targetNamespace = "http://tempuri.org/", wsdlLocation = "file:/D:/projects/LXAFPlatform/src/main/java/websvr/Service.wsdl")
    ...
    extends javax.xml.ws.Service
{
    ...
    static {
        ...
        try {
            url = new URL("file:/D:/projects/LXAFPlatform/src/main/java/websvr/Service.wsdl");
     ...
     *     returns IService
     */
    @WebEndpoint(name = "WSHttpBinding_IService")
    public IService getWSHttpBindingIService() {
        return super.getPort(new QName("http://tempuri.org/", "WSHttpBinding_IService"), IService.class);
    }
     ...
     */
    @WebEndpoint(name = "WSHttpBinding_IService")
    public IService getWSHttpBindingIService(WebServiceFeature... features) {
        return super.getPort(new QName("http://tempuri.org/", "WSHttpBinding_IService"), IService.class, features);
    }
